...
dependencies {
  ...
  implementation("com.pambrose.common-utils:core-utils:2.8.1")
  implementation("com.pambrose.common-utils:json-utils:2.8.1")
  implementation("com.pambrose.common-utils:ktor-server-utils:2.8.1")
    // ... other modules
}
```
