...
dependencies {
    ...
    implementation("com.github.pambrose.common-utils:core-utils:2.4.1")
    implementation("com.github.pambrose.common-utils:json-utils:2.4.1")
    implementation("com.github.pambrose.common-utils:ktor-server-utils:2.4.1")
    // ... other modules
}
```
