...
annotation class Version2(
  ...
  companion object {
    ...
    fun KClass<*>.buildString() = findAnnotation<Version2>()?.run { buildDateTimeStr(buildTime) } ?: UNKNOWN

    fun KClass<*>.buildDateTime() = findAnnotation<Version2>()?.run { buildDateTime(buildTime) }
